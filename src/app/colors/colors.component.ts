...
@Component({
  selector: 'app-colors',
  template: `
    <div class="plum">{{ color }} {{ index }}</div>
  `,
...
@Component({
  ...
  template: `
    <div class="thistle">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-floral',
  template: `
    <div class="floral">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="lollipop">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-teal',
  template: `
    <div class="teal">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="carnation">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="bubblegum">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-ruby',
  template: `
    <div class="ruby">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-lawn',
  template: `
    <div class="lawn">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="honeydew">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="mindaro">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="pistachio">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-yellow',
  template: `
    <div class="yellow">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-cream',
  template: `
    <div class="cream">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  selector: 'app-banana',
  template: `
    <div class="banana">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
...
@Component({
  ...
  template: `
    <div class="trombone">{{ color }} {{ index }}</div>
  `,
  styleUrls: ['./colors.component.scss']
})
